  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Logo Pill */}
        <div className="nav-pill flex items-center gap-3 px-4 py-2.5 rounded-full">
        ...
        {/* Nav Links Pill */}
        <div className="hidden md:flex items-center gap-1 p-1.5 nav-pill rounded-full">
          <Link
            href="#"
        ...
        {/* Auth Pill */}
        <div className="flex items-center gap-2 p-1.5 nav-pill rounded-full">
          <Link
            href="#"
